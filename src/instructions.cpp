...
void CPU::LD_ADDR_HLp_A() { memory.Write8(registers.HL.pair++, registers.AF.solo.A); }
void CPU::LD_ADDR_HLm_A() { memory.Write8(registers.HL.pair--, registers.AF.solo.A); }
void CPU::LD_ADDR_U16_A() { memory.Write8(memory.Read16(registers.PC), registers.AF.solo.A); registers.PC += 2; }
...
void CPU::RLC_ADDR_HL() {
    uint8_t dst = memory.Read8(registers.HL.pair);
    RLC(&dst);
...
void CPU::BIT_0_ADDR_HL() { BIT(0, memory.Read8(registers.HL.pair)); }
void CPU::BIT_1_ADDR_HL() { BIT(1, memory.Read8(registers.HL.pair)); }
void CPU::BIT_2_ADDR_HL() { BIT(2, memory.Read8(registers.HL.pair)); }
void CPU::BIT_3_ADDR_HL() { BIT(3, memory.Read8(registers.HL.pair)); }
void CPU::BIT_4_ADDR_HL() { BIT(4, memory.Read8(registers.HL.pair)); }
void CPU::BIT_5_ADDR_HL() { BIT(5, memory.Read8(registers.HL.pair)); }
void CPU::BIT_6_ADDR_HL() { BIT(6, memory.Read8(registers.HL.pair)); }
void CPU::BIT_7_ADDR_HL() { BIT(7, memory.Read8(registers.HL.pair)); }
